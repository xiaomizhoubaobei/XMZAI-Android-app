/**
 * @fileoverview ChatAdapter 适配器
 * @author 祁筱欣
 * @date 2026-04-05
 * @since 2026-04-05
 * @LICENSE AGPL-3.0 license
 * @remark RecyclerView 适配器，用于ChatAdapter的数据展示与绑定
 */
...
import xmzai.mizhoubaobei.top.http.ImageDownloadService
import xmzai.mizhoubaobei.top.http.ImageDownloader
import xmzai.mizhoubaobei.top.http.ResourceUtils.saveResource
import xmzai.mizhoubaobei.top.infa.OnItemClickListener
import xmzai.mizhoubaobei.top.infa.OnMarkdownImageClickListener
import xmzai.mizhoubaobei.top.infa.OnWordPrintOverClickListener
import xmzai.mizhoubaobei.top.room.ChatItemChat
import xmzai.mizhoubaobei.top.utils.CustomImgTagHandler
import xmzai.mizhoubaobei.top.utils.CustomToast
import xmzai.mizhoubaobei.top.utils.CustomUrlSpan
import xmzai.mizhoubaobei.top.utils.DialogUtils
import xmzai.mizhoubaobei.top.utils.ImageClickPlugin
import xmzai.mizhoubaobei.top.utils.StringObjectUtils
import xmzai.mizhoubaobei.top.utils.StringObjectUtils.generateRandomFilename
import xmzai.mizhoubaobei.top.utils.SystemUtils
import xmzai.mizhoubaobei.top.utils.ViewAnimationUtils
import xmzai.mizhoubaobei.top.view.RemovableImageChatLayout
import xmzai.mizhoubaobei.top.view.RemovableImageLayout

import xmzai.mizhoubaobei.top.view.ThreeCircularLoadingAnim
