/**
 * @fileoverview PermissionOneUtils 工具类
 * @author 祁筱欣
 * @date 2026-04-05
 * @since 2026-04-05
...
import xmzai.mizhoubaobei.top.constant.PermissionConstants;
 ...
 * </pre>
 */
public final class PermissionOneUtils {

    private static PermissionOneUtils sInstance;
    ...
    private static Pair<List<String>, List<String>> getRequestAndDeniedPermissions(final String... permissionsParam) {
        ...
        for (String param : permissionsParam) {
            ...
            if (!isIncludeInManifest) {
                ...
                Log.e("PermissionOneUtils", "U should add the permission of " + param + " in manifest.");
            }
        }
     ...
     *
     * @param permissions The permissions.
     * @return the single {@link PermissionOneUtils} instance
     */
    public static PermissionOneUtils permissionGroup(@PermissionConstants.PermissionGroup final String... permissions) {
     ...
     * @return the single {@link PermissionOneUtils} instance
     */
    public static PermissionOneUtils permission(final String... permissions) {
        return new PermissionOneUtils(permissions);
    }

    private PermissionOneUtils(final String... permissions) {
     ...
     * @return the single {@link PermissionOneUtils} instance
     */
    public PermissionOneUtils explain(final OnExplainListener listener) {
     ...
     * @return the single {@link PermissionOneUtils} instance
     */
    public PermissionOneUtils rationale(final OnRationaleListener listener) {
     ...
     * @return the single {@link PermissionOneUtils} instance
     */
    public PermissionOneUtils callback(final SingleCallback callback) {
     ...
     * @return the single {@link PermissionOneUtils} instance
     */
    public PermissionOneUtils callback(final SimpleCallback callback) {
     ...
     * @return the single {@link PermissionOneUtils} instance
     */
    public PermissionOneUtils callback(final FullCallback callback) {
     ...
     * @return the single {@link PermissionOneUtils} instance
     */
    public PermissionOneUtils theme(final ThemeCallback callback) {
    ...
    public void request() {
        if (mPermissionsParam == null || mPermissionsParam.length <= 0) {
            Log.w("PermissionOneUtils", "No permissions to request.");
            return;
        }
    ...
    static final class PermissionActivityImpl extends UtilsTransActivity.TransActivityDelegate {
        ...
        public void onCreated(@NonNull final UtilsTransActivity activity, @Nullable Bundle savedInstanceState) {
            ...
            if (type == TYPE_RUNTIME) {
                if (sInstance == null) {
                    Log.e("PermissionOneUtils", "sInstance is null.");
                    activity.finish();
                    return;
                }
                if (sInstance.mPermissionsRequest == null) {
                    Log.e("PermissionOneUtils", "mPermissionsRequest is null.");
                    activity.finish();
                    return;
                }
                if (sInstance.mPermissionsRequest.size() <= 0) {
                    Log.e("PermissionOneUtils", "mPermissionsRequest's size is no more than 0.");
                    activity.finish();
                    return;
                }
                ...
                activity.finish();
                Log.e("PermissionOneUtils", "type is wrong.");
            }
        }
