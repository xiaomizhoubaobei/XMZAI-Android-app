/**
 * @fileoverview SerializableCookie 网络模块
 * @author 祁筱欣
 * @date 2026-04-05
 * @since 2026-04-05
...
package xmzai.mizhoubaobei.top.network.cookie.persistence;
...
public class SerializableCookie implements Serializable {
    ...
    public String encode(Cookie cookie) {
        ...
        String string = byteArrayToHexString(byteArrayOutputStream.toByteArray());
//        string = AESUtil.encryptCookie(string);
        return string;
    }
...
//        String newEncodedCookie = AESUtil.decryptCookie(encodedCookie);
