/**
 * @fileoverview ForgetPassWordNewActivity 界面
 * @author 祁筱欣
 * @date 2026-04-05
 * @since 2026-04-05
...
import xmzai.mizhoubaobei.top.bean.EmailCodeBeanRes
import xmzai.mizhoubaobei.top.databinding.ActivityForgetPasswordNewBinding
...
import xmzai.mizhoubaobei.top.widget.view.PassWorkEditView
import xmzai.mizhoubaobei.top.widget.view.PhoneLocationView
...
//        hashMap["code"] = mRandomNum
    ...
    private fun setEmailVerifyCodeState() {
        ...
        countDownTimer = object : CountDownTimer(60000L, 1000L) {
            override fun onTick(millisUntilFinished: Long) {
                mBinding?.tvEmailVerifyCode?.setTextColor(ContextCompat.getColor(this@ForgetPassWordNewActivity, R.color.white))
                ...
                mBinding?.tvEmailVerifyCode?.setTextColor(ContextCompat.getColor(this@ForgetPassWordNewActivity, R.color.un_selected))
            }
    ...
    private fun setPhoneVerifyCodeState() {
        ...
        countDownTimer = object : CountDownTimer(60000L, 1000L) {
            override fun onTick(millisUntilFinished: Long) {
                mBinding?.tvVerifyCode?.setTextColor(ContextCompat.getColor(this@ForgetPassWordNewActivity, R.color.white))
