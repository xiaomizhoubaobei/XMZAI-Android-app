/**
 * @fileoverview PassWorkEditView 自定义视图
 * @author 祁筱欣
 * @date 2026-04-05
 * @since 2026-04-05
...
import xmzai.mizhoubaobei.top.databinding.LayoutPasswordEditViewBinding
 ...
 */
class PassWorkEditView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
    ...
    private val mBinding: LayoutPasswordEditViewBinding by lazy {
        LayoutPasswordEditViewBinding.bind(
            View.inflate(
                context,
                R.layout.layout_password_edit_view,
                this
            )
        )
    }
