/**
 * @fileoverview KeyboardOneUtils 工具类
 * @author 祁筱欣
 * @date 2026-04-05
 * @since 2026-04-05
 ...
 * </pre>
 */
public final class KeyboardOneUtils {

    private static final int TAG_ON_GLOBAL_LAYOUT_LISTENER = -8;

    private KeyboardOneUtils() {
    ...
    public static void hideSoftInputByToggle(@Nullable final Activity activity) {
        ...
        if (Math.abs(delta) > 500 && KeyboardOneUtils.isSoftInputVisible(activity)) {
            KeyboardOneUtils.toggleSoftInput();
        }
        millis = nowMillis;
    }
